...
今天，又修复一次，视频不点击的bug！
[安装包下载](https://github.com/admin0008/LazyStudy/releases/download/2.6.9%EF%BC%88fix%EF%BC%89/_v2.6.9.fix3.apk) 
...
## 总体来说没什么大的bug了，以后不在维护这个更新，下面的是之前的更新：
...
- 修改文章和视听学习内容，通过收藏来判断是否重复的逻辑，现在可以一次正确，不会出现文章或视频学习个数不够的情况；
- 其它小修改若干……
